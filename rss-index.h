...
/**
 * After all threads finish this method iterate through the tracker map
 * and update the index with all the word vectors.
 */
  void updateIndex();
 ...
 */
 ...
 private:
  ...
  std::map<std::pair<std::string /*Article title*/, std::string /*server*/>, std::pair<std::string/*Aticleurl*/,std::vector<std::string>>> tracker;
